...
<section class="program-hero">
    <div class="container program-hero__inner">
        ...
        <div class="program-hero__media">
            <img src="{{ asset('assets/dakwah (1).png') }}" alt="Program Peduli Dakwah" class="program-hero__img">
        </div>
...
<section class="cpm">
    {{-- Container HANYA membungkus Judul & Intro Kiri --}}
    <div class="container">
        ...
        <div class="cpm__inner">
            ...
            {{-- Slider card BERADA DI DALAM .cpm__inner TAPI TETAP BISA OVERFLOW KE KANAN --}}
