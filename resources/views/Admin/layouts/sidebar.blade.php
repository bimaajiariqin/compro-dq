...
<aside id="sidebar"
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('admin.hero-setting.edit') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition
                  {{ request()->routeIs('admin.hero-setting.*') || request()->routeIs('admin.hero-stat.*') ? 'bg-white/10 text-white font-medium' : 'hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.faq.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition
                  {{ request()->routeIs('admin.faq.*') ? 'bg-white/10 text-white font-medium' : 'hover:bg-white/5 hover:text-white' }}">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="12" cy="12" r="9"/><path d="M9.5 9a2.5 2.5 0 0 1 4.9.8c0 1.7-2.4 2-2.4 3.7"/><path d="M12 17.2h.01"/>
            </svg>
            FAQ
        </a>
        ...
        <a href="{{ route('admin.cerita-penerima-manfaat.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition
                  {{ request()->routeIs('admin.cerita-penerima-manfaat.*') ? 'bg-white/10 text-white font-medium' : 'hover:bg-white/5 hover:text-white' }}">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="{{ route('admin.legalitas.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition
                  {{ request()->routeIs('admin.legalitas.*') ? 'bg-white/10 text-white font-medium' : 'hover:bg-white/5 hover:text-white' }}">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 3 4 6v6c0 5 3.5 8.5 8 9 4.5-.5 8-4 8-9V6l-8-3Z"/><path d="m9.5 12 2 2 3.5-4"/>
            </svg>
            Legalitas Lembaga
        </a>
        ...
        <a href="{{ route('admin.pengurus.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition
                  {{ request()->routeIs('admin.pengurus.*') ? 'bg-white/10 text-white font-medium' : 'hover:bg-white/5 hover:text-white' }}">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="9" cy="7" r="3"/><circle cx="17" cy="7" r="2.5"/>
                <path d="M2 21c0-3.5 3-6 7-6s7 2.5 7 6"/><path d="M15.5 15c3.2.3 5.5 2.6 5.5 6"/>
            </svg>
            Profil Kepengurusan
        </a>
        ...
        class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition
                {{ request()->routeIs('admin.mitra.*') ? 'bg-white/10 text-white font-medium' : 'hover:bg-white/5 hover:text-white' }}">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
